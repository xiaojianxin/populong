	...
	<div id="container">
		...
		<!-- <div id="header">
			...
			if (isset($_SESSION["token"]))
			{
				...
				<div id="dropdown">
					<li>
						<img src="./img/index_details5.png" alt="" />
						<a href="./self.php">消息</a>
					</li>
					<li class="chooseli">
						<img src="./img/index_details6.png" alt="" />
						<a href="./self.html">个人中心</a>
					</li>
					<li>
						<img src="./img/index_details7.png" alt="" />
						<a href="./self.html">资金管理</a>
					</li>
					<li>
						<img src="./img/index_details8.png" alt="" />
						<a href="./self.html">项目管理</a>
					</li>
					<li>
						<img src="./img/index_details9.png" alt="" />
						<a href="./action/do_logout.php">退出</a>
					</li>
				</div>
				<ul id="name" onmouseover=dropdown();>
					<li id="div1" style="float:right;text-style:normal;"><a href="#" style="font-weight: lighter;"> <?PHP echo $_SESSION["nickname"]?> </a></li>
				</ul>
			...
			}else
			{
				...
				<ul style="float:right;margin-right:11%;">
					<li id="tlogin"><a href="#"onclick=login()>登录</a></li>
					<li style="float:right"><a href="./regist_1.html">注册</a></li>
				</ul>
				<div id="back"></div>
				<form action="./action/do_login.php?from=help" method="post">
					<div id="login">
						<img src="./img/login_01.png" alt="" />
						<h1>登录</h1>
						<input class="login_username" type="text" name="inputEmail" placeholder="邮箱/手机">
						<input class="login_passwd" type="password" name="inputPassword" placeholder="登录密码">
						<input class="remember" type="checkbox">
						<h2>记住用户名&nbsp;&nbsp;</h2>
						<a id="tofind1"href="#">忘记密码/</a>
						<a id="toregist"href="./regist_1.html">快速注册</a>
						<input type="submit"value="登录"/class="checklogin">
					</div>
				</form>
				<form action="">
					<div id="find1">
						...
						<h1>找回密码</h1>
						<input class="login_username" type="text" name=""placeholder="邮箱/手机">
						<input class="login_passwd" type="text" name=""placeholder="验证码">
					...
					<div id="find2">
						...
						<input class="login_passwd" type="text" name=""placeholder="验证码">
						<input class="login_passwd_button" type="button" name=""placeholder="60秒后再次发送">
