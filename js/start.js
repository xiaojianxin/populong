...
//地址选择构造函数
    ...
    me.place=$("#selectCity").find("select").eq(0).val();
    this.bindEvent=function(){
        ...
        $("#gain_num").bind("blur",function(){
            ...
            {
                error.text("筹集资金不能为空");
                me.judgeItem.gainMoney=false;
            }
            else if(num>=10000)
            {
                error.text("");
                me.judgeItem.gainMoney=true;
            }
        ...
        $('#nextstep').click(function(e){
            if(me.judgeItem.abst==true&&me.judgeItem.gainMoney==true&&me.judgeItem.name==true&&me.judgeItem.place==true&&me.judgeItem.raiseDays==true)
            {
                ...
                alert("请检查必填项");
                window.location.hash = "#projNameError";
            }
